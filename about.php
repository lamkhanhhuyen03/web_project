  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <img src="images/FindJobdex.jpg" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">Why IT JOBS</h2>
            <p>Có việc làm IT theo kỹ năng</p>
            <p class="mb-4">Có việc làm IT theo cấp bậc</p>

            <ul class="ul-check list-unstyled primary">
              <li>Lương Cao</li>
              <li>Môi trường làm việc thoải mái</li>
              <li>Tận dụng được tài năng của mọi người</li>
            </ul>
          </div>
        </div>
      </div>
